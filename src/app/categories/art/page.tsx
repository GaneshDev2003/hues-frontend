  ...
  return (
    <div>
        <div className = "bg-white text-slate-800 container mx-auto px-4 py-16">
            ...
            <img className = "object-contain w-full" src = "/images/drawing.png"></img>
            ...
            <div className='flex flex-col gap-y-4'>
                    ...
                    <div className = "bg-cover bg-no-repeat py-5 px-3 overflow-hidden text-center"  style={{backgroundImage: 'url("/images/rectangle.svg")'}}>
                        ...
                        <p>Discover tranquility through the simple act of drawing intricate circles</p>
                    </div>
                    ...
                    <div className = "bg-cover bg-no-repeat p-5 overflow-hidden text-center"  style={{backgroundImage: 'url("/images/rectangle-alt.png")'}}>
                        ...
                        <p>Express yourself freely by piecing together bits of your imagination</p>
                    </div>
                    ...
                    <div className = "bg-cover bg-no-repeat p-5 overflow-hidden text-center"  style={{backgroundImage: 'url("/images/rectangle.svg")'}}>
                        ...
                        <p>Unleash creativity with power of lines, effortlessly creating dynamic art</p>
                    </div>

                    <div className = "bg-cover bg-no-repeat p-5 overflow-hidden text-center"  style={{backgroundImage: 'url("/images/rectangle-alt.png")'}}>
                        <h2 className = "font-semibold text-lg">Doodling</h2>
                        <p>Release stress and spark inspiration with playful, spontaneous doodles</p>
                    </div>
               </div>
        </div>
